...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("set-new-password", data);
      
      if (response.data.status) {
        toast.success(response.data.message || "Successfully Reset Password", {
          position: "top-right",
          autoClose: 2000,
        });
        ...
        <div className="gto-card">
          ...
          <div className="gto-form-panel">
            <div className="gto-form-content">
              ...
              <p className="gto-title">Set New Password</p>
              ...
              <form onSubmit={handleSubmit}>
                <div className="gto-input-group">
                  <label className="gto-input-label">New Password</label>
                  <input
                    type="password"
                    className="gto-input"
                ...
                <div className="gto-input-group">
                  <label className="gto-input-label">Confirm Password</label>
                  <input
                    type="password"
                    className="gto-input"

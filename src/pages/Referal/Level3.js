...
const Level3 = () => {
  ...
  return (
    <>
      ...
      <div className="level3-wrapper poppins">
        <div className="container py-5">
          <div className="row justify-content-center text-center slide-up">
            
            {/* Header Section */}
            <div className="col-12 mb-4">
              <span className="badge-level">Level 3 Unlocked</span>
              <h3 className="page-title mt-2">
                Level 3 Referral Bonus: <br className="d-md-none" />
                <span className="highlight-text">Earn 12 Bonus Bids!</span>
              </h3>
            </div>
            ...
            <div className="col-lg-6 col-md-8 col-11">
              <div className="glass-card">
                ...
                <h6 className="description-text">
                  Invite your extended network and earn an indirect bonus of <strong style={{ color: theme.pureWhite }}>12 bids</strong> for every successful referral. 
                ...
                <div className="mt-4">
                  ...
                  <div className="d-flex justify-content-center align-items-center gap-3 gap-md-4 mt-3">
                    <button className="social-btn" onClick={() => window.open(`mailto:?subject=Join GrapeTask&body=${referralLink}`)}>
                      <FaEnvelope size={20} />
                    </button>
                    <button className="social-btn" onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${referralLink}`)}>
                      <BsFacebook size={20} />
                    </button>
                    <button className="social-btn" onClick={() => window.open(`fb-messenger://share/?link=${referralLink}`)}>
                      <BsMessenger size={20} />
                    </button>
                    <button className="social-btn" onClick={() => window.open(`https://twitter.com/intent/tweet?url=${referralLink}`)}>
                      <FaTwitter size={20} />
                    </button>
                  </div>
                </div>
